    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto px-5 py-10 md:px-10 md:py-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          ...
          >
            <motion.h1 
              ...
              variants={fadeIn}
            >
              Operations & CX for <span className="text-primary">Logistics & Delivery</span>
            </motion.h1>
            <motion.h3 
              className="text-xl text-slate-600 mb-0 leading-relaxed font-light max-w-lg mx-auto lg:mx-0"
              variants={fadeIn}
            >
              Real-time support for drivers, dispatchers, and customers. Keeping goods and information moving 24/7.
            </motion.h3>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-heading font-bold text-slate-900 mb-4">Logistics Support Capabilities</h2>
            <p className="text-lg text-slate-600">
              Operations support for the supply chain.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
             {[
               { title: "Driver Support", desc: "Assisting drivers with routes, app issues, and live updates.", icon: Truck },
               { title: "Customer Tracking", desc: "Providing real-time shipment status and ETA updates.", icon: Monitor },
               { title: "Exception Management", desc: "Handling delays, lost packages, and delivery failures.", icon: ShieldCheck },
               { title: "Dispatch Coordination", desc: "Connecting drivers with dispatchers and hubs.", icon: Network },
               { title: "Data Entry & Manifests", desc: "Processing shipping documents and BOLs.", icon: Database },
               { title: "Claims & Returns", desc: "Managing damage claims and reverse logistics.", icon: BadgeDollarSign }
             ].map((item, i) => (
      ...
      <section className="py-24 bg-white text-center border-t border-slate-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-6">Keep Your Operations Moving</h2>
          <Link href="/contact">
