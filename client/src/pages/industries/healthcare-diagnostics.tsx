    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto px-5 py-10 md:px-10 md:py-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          ...
          >
            <motion.h1 
              ...
              variants={fadeIn}
            >
              Operations & CX for <span className="text-primary">Healthcare</span>
            </motion.h1>
            <motion.h3 
              className="text-xl text-slate-600 mb-0 leading-relaxed font-light max-w-lg mx-auto lg:mx-0"
              variants={fadeIn}
            >
              Empathetic patient support, appointment scheduling, and back-office management. HIPAA-compliant and secure.
            </motion.h3>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-heading font-bold text-slate-900 mb-4">Healthcare Support Capabilities</h2>
            <p className="text-lg text-slate-600">
              Care-focused operations for clinics, labs, and health tech.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
             {[
               { title: "Patient Scheduling", desc: "Booking appointments and managing cancellations.", icon: Stethoscope },
               { title: "Insurance Verification", desc: "Checking eligibility and benefits before appointments.", icon: ShieldCheck },
               { title: "Billing Inquiries", desc: "Explaining statements and handling payment plans.", icon: BadgeDollarSign },
               { title: "Telehealth Support", desc: "Helping patients connect to virtual visits.", icon: Monitor },
               { title: "Lab Results Retrieval", desc: "Assisting patients with accessing their portals.", icon: Database },
               { title: "Referral Management", desc: "Processing and tracking referrals to specialists.", icon: Network }
             ].map((item, i) => (
      ...
      <section className="py-24 bg-white text-center border-t border-slate-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-6">Enhance Patient Experience</h2>
          <Link href="/contact">
